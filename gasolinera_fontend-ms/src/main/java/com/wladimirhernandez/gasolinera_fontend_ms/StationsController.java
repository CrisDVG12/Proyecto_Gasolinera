package com.Cristian-Vidal.Gasstation;
...
public class StationsController {
    ...
    // esta es la lista para almacenar las estaciones de servicio
    private final List<GasStation> stations = new ArrayList<>();

    // este es el constructor para inicializar la lista con datos de ejemplo
    ...
    // el endpoint para obtener todas las estaciones de servicio
    @GetMapping
